        ...
        return (
            <div className="w-full">
                <div>
                    ...
                    <div>
                        <button className="absolute top-1/2 left-1/20 p-2 rounded-full hover:bg-gray-400/40 z-50" onClick={() => this.move(DIRECTIONS.LEFT)}><IoIosArrowBack /></button>
                        <button className="absolute top-1/2 right-1/20 p-2 rounded-full hover:bg-gray-400/40 z-50" onClick={() => this.move(DIRECTIONS.RIGHT)}><IoIosArrowForward /></button>
                        <button className="absolute top-1/20 left-1/2 p-2 rounded-full hover:bg-gray-400/40 z-50" onClick={() => this.move(DIRECTIONS.UP)}><IoIosArrowUp /></button>
                        <button className="absolute bottom-1/20 left-1/2 p-2 rounded-full hover:bg-gray-400/40 z-50" onClick={() => this.move(DIRECTIONS.DOWN)}><IoIosArrowDown /></button>
                    </div>
